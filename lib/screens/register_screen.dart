...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _handleRegister() async {
    ...
    if (error != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('✅ Cuenta creada. ¡Bienvenido!'), backgroundColor: Colors.green),
      );
                ...
                children: [
                  ...
                  _buildField(
                    ...
                    validator: (v) {
                      ...
                      if (!RegExp(r'^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$').hasMatch(v.trim())) return 'Solo letras y espacios';
                      return null;
                    },
                  ),
                  ...
                  _buildField(
                    ...
                    validator: (v) {
                      if (v == null || v.trim().isEmpty) return 'Campo requerido';
                      if (!EmailValidator.validate(v.trim())) return 'Formato de correo inválido';
                      return null;
                    },
                  ),
                  const SizedBox(height: 16),
                  ...
                  _buildField(
                    ...
                    suffixIcon: IconButton(
                      icon: Icon(_obscureConfirm ? Icons.visibility_outlined : Icons.visibility_off_outlined, color: Colors.white54, size: 20),
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          _hint('Al menos 1 carácter especial', pass.contains(RegExp(r'[!@#\$%^&*(),.?":{}|<>]'))),
        ],
      ),
    );
  }
  ...
  Widget _hint(String text, bool ok) {
    return Padding(
      ...
      child: Row(
        children: [
          Icon(ok ? Icons.check_circle : Icons.radio_button_unchecked, size: 14, color: ok ? Colors.greenAccent : Colors.white38),
          const SizedBox(width: 6),
          Text(text, style: TextStyle(fontSize: 12, color: ok ? Colors.greenAccent : Colors.white38)),
        ],
      ),
    );
  }
